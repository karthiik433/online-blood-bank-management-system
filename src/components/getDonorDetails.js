...
function GetDonorDetails () {
    ...
    return(
        <>
        {
            ...
            <>
             ...
             return(
                 <div className="donorList" key={index}>
                     <h3 style={{color:"blueviolet",textDecoration:"underline"}}>Donor {index+1}</h3>
            ...
            <div className="getDonorBody">
            <h1>Welcome</h1>
            <h3>Please select the district</h3>
            <div  className="getDonorForm">
            <select onChange={getDistrict}>
             ...
             <button type="sumbit" onClick={getData} >Search</button>
             </div>
